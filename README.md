...
This branch includes the files for Microsoft Visual Studio 2015+ in conjunction with the excellent [Visual Micro](http://www.visualmicro.com/) - the fully compatible Arduino programming tool for Microsoft Visual Studio. 
